            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.infoContainer}>
                    <View style={styles.infoItem}>
                        <Image source={require('../assets/DoNotBleach.png')} style={styles.infoIcon} />
                        <Text style={styles.infoText}>Do not use bleach</Text>
                    </View>
                    <View style={styles.infoItem}>
                        <Image source={require('../assets/DoNotTumbleDry.png')} style={styles.infoIcon} />
                        <Text style={styles.infoText}>Do not tumble dry</Text>
                    </View>
                    <View style={styles.infoItem}>
                        <Image source={require('../assets/DoNotWash.png')} style={styles.infoIcon} />
                        <Text style={styles.infoText}>Dry clean with tetrachloroethylene</Text>
                    </View>
                    <View style={styles.infoItem}>
                        <Image source={require('../assets/IronLowTemperature.png')} style={styles.infoIcon} />
                ...
                <TouchableOpacity style={styles.addButton} onPress={() => handleAddToCart(product)}>
                    <Image source={require('../assets/Plus.png')} style={[styles.plusIcon, {tintColor: '#fff'}] } />
                    <Text style={styles.buttonText}>ADD TO BASKET</Text>
                    <Image source={require('../assets/Heart.png')} style={[styles.heartIcon, {tintColor: '#fff'}]} />
                </TouchableOpacity>
            </ScrollView>
        </View>
    );
